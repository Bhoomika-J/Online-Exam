                ...
                <ul >
                    <?php 
                        ...
                        if($selExam->rowCount() > 0)
                        {
							...
							if(date('Y-m-d') == date('Y-m-d',strtotime($selExamRow['dt'])) && date('h:i:s') >= date('h:i:s',strtotime($selExamRow['dt'])) )
							{
							?>
                                 <li>
							...
							else
							{
								?>
                                 <li>
                                 <a href="#" id="startQuiz1" data-id="<?php echo $selExamRow['ex_id']; ?>"  >
                                    <?php 
                                        $lenthOfTxt = strlen($selExamRow['ex_title']);
                                        if($lenthOfTxt >= 23)
                                        { ?>
                                        ...
                                        else
                                        {
											...
											/*?><small> (<?= date('d-m-Y h:i A',strtotime($selExamRow['dt'])); ?>)</small><?php*/
											//echo date('h:i:s');
                                        }
                                     ?>
                                 </a>
