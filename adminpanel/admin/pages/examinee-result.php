                                    ...
                                    while ($selExmneRow = $selExmne->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
										   ...
										   <video width="200" height="200" controls>
												<source src="../../../exam/pages/RecordRTC-to-PHP/uploads/<?php echo $selExName['video'];?>" type="video/webm">
											</video>
                                           ...
                                           <td>
                                               <a rel="facebox" href="facebox_modal/updateExaminee.php?id=<?php echo $selExmneRow['exmne_id']; ?>" class="btn btn-sm btn-primary">Download</a>
