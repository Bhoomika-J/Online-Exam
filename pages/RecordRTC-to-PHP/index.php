    ...
    <article>
        ...
        <section class="experiment recordrtc">
            <h2 class="header">
                ...
                <button id="watchButton" style="display:none;" >Start Recording</button>
				<button id="upload-to-server" style="display:none;">Upload To Server</button>
            </h2>

            <video  playsinline autoplay muted=false volume=1 style="width:300px;height:300px;"></video>
        </section>
        ...
        <script>
			...
			{
				var button = document.querySelector('#watchButton');
				var commonConfig = {
			...
			function stopRecording(exam_id)
			{
				//alert('test');
				var button = document.querySelector('#watchButton');
					...
					if(button.recordRTC.length) {
						button.recordRTC[0].stopRecording(function(url) {
							if(!button.recordRTC[1]) {
								...
								saveToDiskOrOpenNewTab(button.recordRTC[0],exam_id);
								return;
							}
						...
						button.recordRTC.stopRecording(function(url) {
							...
							saveToDiskOrOpenNewTab(button.recordRTC,exam_id);
						});
					}
				}
           ...
           /* recordingDIV.querySelector('button1').onclick = function() {
			alert(recordingMedia.value);
                var button = this;
            ...
            function saveToDiskOrOpenNewTab(recordRTC,exam_id) {
              /*  recordingDIV.querySelector('#save-to-disk').parentNode.style.display = 'block';
                ...
                //recordingDIV.querySelector('#upload-to-server').onclick = function() {
					...
					//alert('test1');
                        if(progress === 'ended') {
							parent.window.location.href='../../home.php?page=result&id=' + exam_id;
						//alert('test2');
                            button.disabled = false;
			...
			//alert('test4');
				...
				//alert ('Uploading ' + fileType + ' recording to server.');
                callback('Uploading ' + fileType + ' recording to server.');

                // var upload_url = 'http://localhost/exam/pages/RecordRTC-to-PHP/uploads/';
                var upload_url = 'save.php';
				//alert(upload_url);alert('test5');
                ...
                makeXMLHttpRequest(upload_url, formData, function(progress) {
                    ...
                    listOfFilesUploaded.push(upload_directory + fileName);
					 ...
					 $.ajax({url: "addData.php?fn="+fileName, success: function(result){
					//alert(result);
				  }});
