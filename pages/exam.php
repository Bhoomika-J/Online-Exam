...
<div class="app-main__inner">
	...
	<iframe src = "http://localhost/exam/pages/RecordRTC-to-PHP/index.php" id="i12" style="width:100%;height:100%;border:none;"></iframe>
 ...
 <script>
 function getsub(exam_id)
 {
	 //alert('test11');
	// var iframe = document.getElementById("#i12");
	//iframe.stopRecording();
	//document.getElementById('#i12').contentWindow.stopRecording();
	window.frames[0].frameElement.contentWindow.stopRecording(exam_id); 
